...
export const SEO_SECTOR_COPY = {
  ...
  ship: withEditorial('ship', {
    titleKo: '조선/해운·조선기자재 밸류체인과 상장 종목',
    titleEn: 'Korean shipbuilding & shipping stocks',
  ...
  metal: withEditorial('metal', {
    titleKo: '철강·비철금속·산업기계 상장 종목',
    titleEn: 'Korean steel, metals and machinery stocks',
    keywordsKo: '철강 관련주, 비철금속, 고려아연, 현대제철, 산업기계',
    keywordsEn: 'Korean steel stocks, nonferrous metals, machinery, Hyundai Steel, Korea Zinc',
  }),
};
...
export const SECTOR_ROUTES = [
  ...
  { id: 'ship', geoKey: 'ship', file: 'ship/korea_ship_map.html', labelKo: '한국 조선/해운 산업 투자 지도', labelEn: 'Korea Shipbuilding & Shipping Map' },
  ...
  { id: 'metal', geoKey: 'metal', file: 'metal/korea_metal_map.html', labelKo: '한국 철강·금속·기계 투자 지도', labelEn: 'Korea Steel, Metals & Machinery Map' },
];
