...
export const SEO_SECTOR_COPY = {
  semiconductor: {
    ...
    bodyEn:
      ...
      'Compare KRX market cap, PER, PBR, and 52-week range for companies including Samsung Electronics and SK hynix, with illustrative relationships to global customers and peers such as NVIDIA, Apple, and TSMC. ' +
      'Listed companies meet a minimum market cap of KRW 300 billion (editorial threshold). Quote and cap fields below are build-time snapshots; live values refresh on trading days.',
  ...
  energy: {
    ...
    bodyEn:
      'This map covers KOSPI and KOSDAQ companies across lithium-ion batteries, ESS, solar PV, and wind power. ' +
      'The table lists market cap, PER, PBR, and value-chain categories for cell, material, and module leaders including LG Energy Solution, Samsung SDI, and Hanwha Solutions. ' +
  ...
  powergrid: {
    ...
    bodyEn:
      'This map covers listed companies in power equipment, transmission & distribution, and power generation equipment. ' +
      'Compare KRX metrics and value-chain categories for HD Hyundai Electric, LS Electric, Doosan Enerbility, and KEPCO, with illustrative global equipment relationships.',
  },
  ship: {
    ...
    bodyEn:
      'This map groups listed Korean yards, engines, steel, marine equipment, offshore, shipping, and naval-marine companies by value chain. ' +
      ...
      'Verify latest order disclosures separately; graph relationships are illustrative.',
  },
  defense: {
    titleKo: '방산·항공·우주 밸류체인과 코스피 방산주',
    titleEn: 'Korean defense, aerospace & space stocks',
    bodyKo:
      '군용 항공기·엔진, 미사일·레이더·C4ISR, 육상무기·탄약, 해군·함정, 우주·위성·민항 등 방산·항공·우주 밸류체인에 속한 상장사를 정리합니다. ' +
    ...
    bodyEn:
      'This map organizes major defense contractors and suppliers across military aviation, missiles and C4ISR, land systems, naval shipbuilding, space, satellites, and civil aviation. ' +
      'Korean defense stocks such as Hanwha Aerospace, LIG Nex1, KAI, and Hyundai Rotem appear with KRX market cap, PER, PBR, and illustrative export-program relationships. ' +
      'Defense stocks are volatile around budgets and geopolitics; informational only, not investment advice.',
  },
  kconsume: {
    titleKo: 'K-소비/유통 상장 종목 지도',
    titleEn: 'K-consume, beauty, fashion & retail stocks',
    bodyKo:
      '화장품·뷰티, 패션, 식품·라면, 쇼핑·유통, 여행·레저 등 K-소비/유통 테마별 KOSPI·KOSDAQ 상장사를 분류합니다. ' +
      '아모레퍼시픽, 삼양식품, 신세계 등 소비재·유통주의 시가총액·PER·PBR과 글로벌 연계 예시를 표와 그래프로 제공합니다.',
    bodyEn:
      'This map groups listed companies by K-consume themes—beauty, fashion, food and ramen, retail, and travel. ' +
      'Explore consumer and retail stocks including Amorepacific, Samyang Foods, and Shinsegae with KRX metrics and illustrative global relationships.',
  },
  kcontent: {
    titleKo: 'K-콘텐츠 상장 종목 지도',
    titleEn: 'K-content, games, media & K-pop stocks',
    bodyKo:
      '게임, 드라마·웹툰·미디어, K-pop 엔터 등 K-콘텐츠 테마별 KOSPI·KOSDAQ 상장사를 분류합니다. ' +
      '하이브, NAVER, 크래프톤 등 IP·플랫폼·엔터주의 시가총액·PER·PBR과 글로벌 연계 예시를 표와 그래프로 제공합니다.',
    bodyEn:
      'This map groups listed companies by K-content themes—games, drama/webtoon/media, and K-pop entertainment. ' +
      'Explore content stocks including HYBE, NAVER, and Krafton with KRX metrics and illustrative global relationships.',
  },
  bio: {
    ...
    bodyEn:
      'This map classifies listed Korean bio and pharma companies by novel drugs, CDMO, biosimilars, devices, and diagnostics (IVD). ' +
      'Compare KRX metrics and illustrative big-pharma licensing and partnership relationships for Samsung Biologics, Celltrion, Alteogen, and other Korean biotech stocks. ' +
  ...
  robot: {
    ...
    bodyEn:
      'This map covers listed companies in factory automation, logistics AMRs, cobots, motion control, sensing, and Physical AI software. ' +
      'Compare KRX data and illustrative global equipment relationships for Rainbow Robotics, Doosan Robotics, Hyundai Mobis, and other Korean robotics stocks. ' +
  ...
  finance: {
    ...
    bodyEn:
      'This map covers listed Korean banks and holdings, securities and asset managers, life and P&C insurers, and card and consumer-finance companies. ' +
      'Compare KRX metrics and illustrative global peer relationships for KB Financial, Shinhan, Samsung Life, Mirae Asset Securities, and other Korean financial stocks. ' +
  ...
  construction: {
    ...
    bodyEn:
      'This map covers listed Korean general contractors, housing developers, construction equipment makers, and related holdings. ' +
      'Compare KRX metrics and illustrative global EPC and equipment peer relationships for Samsung C&T, Hyundai E&C, Daewoo E&C, DL E&C, GS E&C, and peers. ' +
