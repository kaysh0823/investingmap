...
export const SEO_SECTOR_COPY = {
  bigchip: withEditorial('bigchip', {
    titleKo: '삼성전자·SK하이닉스 비교',
    titleEn: 'Samsung Electronics and SK hynix',
    keywordsKo: '삼성전자, SK하이닉스, HBM, 메모리 반도체',
    keywordsEn: 'Samsung Electronics, SK hynix, HBM, memory stocks',
  }),
  ...
  powergrid: withEditorial('powergrid', {
    titleKo: '전력설비·송배전·전선·케이블·발전설비 밸류체인과 상장 종목',
    titleEn: 'Korean power equipment & grid stocks',
    keywordsKo: '전력설비, 송배전, 전선, 케이블, 변압기, 원전 기자재',
    keywordsEn: 'Korean power equipment, T&D, transformers',
  }),
  ship: withEditorial('ship', {
    titleKo: '조선·기자재 밸류체인과 상장 종목',
    titleEn: 'Korean shipbuilding & marine equipment stocks',
    keywordsKo: '조선 관련주, 조선기자재, LNG선',
    keywordsEn: 'Korean shipbuilding stocks, marine equipment, LNG carriers',
  }),
  shipping: withEditorial('shipping', {
    titleKo: '해운·물류 상장 종목 지도',
    titleEn: 'Korean shipping & logistics stocks',
    keywordsKo: '해운, 물류, 항만, HMM',
    keywordsEn: 'Korean shipping, logistics, ports',
  }),
  defense: withEditorial('defense', {
    titleKo: '방산·우주 밸류체인과 코스피 방산주',
    titleEn: 'Korean defense & space stocks',
    keywordsKo: '방산주, 항공우주, 미사일, 함정',
    keywordsEn: 'Korean defense stocks, aerospace, missiles',
  }),
  kconsume: withEditorial('kconsume', {
    titleKo: '소비/유통 상장 종목 지도',
    titleEn: 'Korean consumer & retail listed stocks',
    keywordsKo: '소비/유통, 패션, 식품, 유통, 여행',
    keywordsEn: 'Korean consumer retail, fashion, food stocks',
  }),
  ...
  kcontent: withEditorial('kcontent', {
    titleKo: '콘텐츠 상장 종목 지도',
    titleEn: 'K-content, games, media & K-pop stocks',
    keywordsKo: '콘텐츠, 게임, 웹툰, K-pop, 엔터',
  ...
  holdings: withEditorial('holdings', {
    ...
    keywordsKo: '지주회사, 산업 밸류체인, 그룹주, 지주사 할인',
    keywordsEn: 'Korean holding companies, industry value chains, holding company discount',
  }),
  ...
  chemical: withEditorial('chemical', {
    titleKo: '석유화학·정밀화학·정유·가스 상장 종목',
    titleEn: 'Korean petrochemical, specialty chemical and refining stocks',
    keywordsKo: '화학 관련주, 석유화학, 정유, 특수화학, LPG, 도시가스',
    keywordsEn: 'Korean chemical stocks, petrochemicals, refining, specialty chemicals, LPG, city gas',
  }),
  travel: withEditorial('travel', {
    titleKo: '항공·카지노·호텔·여행·면세 상장 종목',
    titleEn: 'Korean travel, leisure, airline and hotel stocks',
    keywordsKo: '여행 관련주, 항공, 카지노, 호텔, 면세점, 대한항공, 강원랜드',
    keywordsEn: 'Korean travel stocks, airlines, casino, hotels, duty-free',
  }),
  elec: withEditorial('elec', {
    titleKo: '가전·디스플레이·전자부품·전선 상장 종목',
    titleEn: 'Korean electrical and electronics stocks',
    keywordsKo: '전기전자 관련주, 가전, 디스플레이, 전자부품, MLCC',
    keywordsEn: 'Korean electronics stocks, appliances, display, electronic components, MLCC',
  }),
  metal: withEditorial('metal', {
    titleKo: '철강·비철금속 상장 종목',
    titleEn: 'Korean steel & nonferrous metals stocks',
    keywordsKo: '철강 관련주, 비철금속, 고려아연, 현대제철',
    keywordsEn: 'Korean steel stocks, nonferrous metals, Hyundai Steel, Korea Zinc',
  }),
  machinery: withEditorial('machinery', {
    titleKo: '산업·건설기계 상장 종목',
    titleEn: 'Korean industrial & construction machinery stocks',
    keywordsKo: '산업기계, 건설기계, 두산밥캣, 현대엘리베이터',
    keywordsEn: 'Korean machinery, construction equipment, Doosan Bobcat, Hyundai Elevator',
  }),
};

export const SECTOR_ROUTES = [
  { id: 'bigchip', geoKey: 'bigchip', file: 'bigchip/korea_bigchip_map.html', labelKo: '한국 삼성전자/하이닉스 투자 지도', labelEn: 'Korea Samsung/SK hynix Map' },
  ...
  { id: 'ship', geoKey: 'ship', file: 'ship/korea_ship_map.html', labelKo: '한국 조선·기자재 투자 지도', labelEn: 'Korea Shipbuilding & Marine Equipment Map' },
  { id: 'shipping', geoKey: 'shipping', file: 'shipping/korea_shipping_map.html', labelKo: '한국 해운·물류 투자 지도', labelEn: 'Korea Shipping & Logistics Map' },
  { id: 'defense', geoKey: 'defense', file: 'defense/korea_defense_map.html', labelKo: '한국 방산·우주 산업 투자 지도', labelEn: 'Korea Defense & Space Map' },
  { id: 'kconsume', geoKey: 'kconsume', file: 'kconsume/korea_kconsume_map.html', labelKo: '한국 소비/유통 투자 지도', labelEn: 'Korea Consumer / Retail Map' },
  ...
  { id: 'kcontent', geoKey: 'kcontent', file: 'kcontent/korea_kcontent_map.html', labelKo: '한국 콘텐츠 투자 지도', labelEn: 'Korea K-Content Industry Map' },
  ...
  { id: 'chemical', geoKey: 'chemical', file: 'chemical/korea_chemical_map.html', labelKo: '한국 화학·정유 투자 지도', labelEn: 'Korea Chemicals & Refining Map' },
  { id: 'travel', geoKey: 'travel', file: 'travel/korea_travel_map.html', labelKo: '한국 여행·레저·항공 투자 지도', labelEn: 'Korea Travel, Leisure & Airlines Map' },
  { id: 'elec', geoKey: 'elec', file: 'elec/korea_elec_map.html', labelKo: '한국 전기·전자 투자 지도', labelEn: 'Korea Electrical & Electronics Map' },
  { id: 'metal', geoKey: 'metal', file: 'metal/korea_metal_map.html', labelKo: '한국 철강·비철금속 투자 지도', labelEn: 'Korea Steel & Nonferrous Metals Map' },
  { id: 'machinery', geoKey: 'machinery', file: 'machinery/korea_machinery_map.html', labelKo: '한국 산업·건설기계 투자 지도', labelEn: 'Korea Industrial & Construction Machinery Map' },
];
