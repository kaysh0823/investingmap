...
export const SEO_SECTOR_COPY = {
  ...
  kculture: {
    ...
    bodyEn:
      'This map groups listed companies by K-culture export themes—ramen and food, travel and airlines, beauty, drama and webtoon IP, streaming, and K-pop labels. ' +
      'Explore K-culture stocks including Samyang Foods, HYBE, NAVER, and Amorepacific with KRX metrics and illustrative global demand relationships tied to themes such as Buldak ramen, BTS, and K-drama.',
  },
  bio: {
