...
export const SEO_SECTOR_COPY = {
  ...
  medtech: withEditorial('medtech', {
    titleKo: '진단·임플란트·미용기기·의료장비 상장 종목',
    titleEn: 'Korean medtech, diagnostics & aesthetic devices',
    keywordsKo: '의료기기, 진단, IVD, 임플란트, 미용기기',
    keywordsEn: 'Korean medtech, diagnostics, implants, aesthetic devices',
  }),
...
export const SECTOR_ROUTES = [
  ...
  { id: 'medtech', geoKey: 'medtech', file: 'medtech/korea_medtech_map.html', labelKo: '한국 의료·미용기기 투자 지도', labelEn: 'Korea MedTech Map' },
