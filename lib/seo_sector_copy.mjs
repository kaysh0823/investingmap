...
export const SEO_SECTOR_COPY = {
  ...
  energy: {
    titleKo: '에너지·2차전지·전력기기 밸류체인과 상장 종목',
    titleEn: 'Korean energy, battery & power-equipment stocks',
    bodyKo:
      '신재생·2차전지·태양광·풍력·원자력·전력기기·ESS·수소·연료전지·전력·가스 유틸리티까지 에너지·파워플랜트 밸류체인에 속한 KOSPI·KOSDAQ 상장사를 정리합니다. ' +
      'LG에너지솔루션, 삼성SDI, 두산에너빌리티, 한국전력 등 2차전지·발전·송전·EPC·소재 종목의 시가총액·PER·PBR과 밸류체인 태그를 표로 제공하고, CATL·Tesla·Siemens Energy 등 글로벌 참고 관계를 연결합니다. ' +
      '에너지 전환·전력 수요·원자재 가격 민감도가 큰 섹터이므로 공시·정책 변화를 함께 확인하시기 바랍니다.',
    bodyEn:
      'Covers KOSPI/KOSDAQ names across renewables, batteries, solar, wind, nuclear, grid equipment, ESS, hydrogen, fuel cells, and utilities. ' +
      'The table lists market cap, PER, PBR, and value-chain tags for battery, power, and EPC leaders including LG Energy Solution, Samsung SDI, Doosan Enerbility, and KEPCO, with reference links to global peers. ' +
...
export const SECTOR_ROUTES = [
  ...
  { id: 'energy', geoKey: 'energy', file: 'energy/korea_energy_map.html', labelKo: '한국 에너지/파워플랜트 투자 지도', labelEn: 'Korea Energy & Power Plant Map' },
