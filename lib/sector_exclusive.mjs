 ...
 *
 * Single-home exclusivity via SECTOR_EXCLUSIVE. SECTOR_CROSS is empty (no multi-map listings).
 */
export const SECTOR_EXCLUSIVE = {
  '332570': 'elec', // PS일렉트로닉스 (semi→elec 전자부품·기판)
  '323280': 'semi', // 태성 (P3 mcap admission → 전공정 장비)
  '127120': 'bio', // 제이에스링크 (semi→bio 연구도구·서비스)
  ...
  '015360': 'holdings', // INVENI (semi→holdings 에너지·화학)
  ...
  '033790': 'battery', // 피노 (battery 양극재·전구체)
  ...
  '437730': 'robot', // 삼현 (휴머노이드 관절 액추에이터·구동부품)
  ...
  '377300': 'finance', // 카카오페이 — 금융만
  '034020': 'nuclear', // 두산에너빌리티 — 원전만
  '028260': 'construction', // 삼성물산 — 건설만
};

/**
 * Explicit multi-sector membership. Ticker may appear only in listed sector keys.
 * Empty: all former cross homes resolved to SECTOR_EXCLUSIVE single-home.
 */
