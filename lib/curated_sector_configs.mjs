...
export const ELEC_CONFIG = {
  ...
  subtitleKo: '가전·디스플레이·카메라모듈·전자부품·전선 관련 국내 상장사와 글로벌 peer',
  subtitleEn: 'Listed Korean appliances, displays, camera modules, electronic components and cables with global peers',
  chains: [
    ...
    C('전선·케이블', '전선·케이블', 'Wire & cable', '#8D6E63'),
  ],
  globals: PEERS.elec,
  companies: [
    ...
    P('gaon_cable', '가온전선', 'Gaon Cable', '000500', '전선·케이블', '전선·케이블', 'Wire and cable', '전력·통신 케이블', 'Power and communications cables', ['panasonic']),
    P('daewon_cable', '대원전선', 'Daewon Cable', '006340', '전선·케이블', '전선·케이블', 'Wire and cable', '전선·케이블 제조', 'Wire and cable manufacturing', ['panasonic']),
  ],
};
