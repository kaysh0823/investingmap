...
const INDUSTRY_HEADERS = [
  ...
  { re: /^##\s*\d*[\.)]?\s*자동차/i, key: 'auto' },
  { re: /^##\s*Auto\s*$/i, key: 'auto' },
  { re: /^##\s*\d*[\.)]?\s*의료\/?미용기기/i, key: 'medtech' },
  { re: /^##\s*의료기기/i, key: 'medtech' },
  { re: /^##\s*의료기기\(지도\)/i, key: 'medtech' },
  { re: /^##\s*MedTech\s*$/i, key: 'medtech' },
  ...
  { re: /^##\s*금속·기계\(지도\)/i, key: 'metal' },
  { re: /^##\s*전기·전자\(지도\)/i, key: 'elec' },
  { re: /^##\s*자동차\(지도\)/i, key: 'auto' },
  { re: /^##\s*통신\(지도\)/i, key: 'telecom' },
  { re: /^##\s*화학·정유\(지도\)/i, key: 'chemical' },
  { re: /^##\s*여행·레저\(지도\)/i, key: 'travel' },
  { re: /^##\s*지주\(지도\)/i, key: 'holdings' },
  { re: /^##\s*IT·소프트웨어/i, key: 'software' },
];
