...
const RULES = {
  ...
  energy: [
    [/ESS|배터리|2차전지|양극|음극|전해질|리튬/i, 'ESS·배터리'],
    [/전력설비|송배전|변압|케이블|스위치|전선/i, '전력설비·송배전'],
    [/태양|풍력|신재생|솔라|풍/i, '태양광·풍력'],
    [/원자력|원전|발전설비|터빈/i, '원자력·발전설비'],
    [/수소|연료전지|SOFC|PEM/i, '수소·연료전지'],
    [/전력|가스|LNG|유틸|발전/i, '전력·가스'],
    [/화학|정유|석유/i, '전력·가스'],
  ],
  kculture: [
    ...
    [/드라마|미디어|웹툰|컨텐츠|콘텐츠|OTT|게임|영화/i, '드라마·미디어·웹툰·컨텐츠'],
