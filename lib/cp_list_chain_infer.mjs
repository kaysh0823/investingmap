...
const RULES = {
  ...
  // 상위 키워드가 섞인 표기가 IDM으로 흡수되지 않도록 좁은 규칙을 먼저 둔다.
  semi: [
    [/IDM|종합반도체|메모리\s*[·,]\s*(?:파운드리|HBM)|HBM\s*[·,]\s*메모리/i, 'IDM'],
    ...
    [/전구체|케미칼|가스|소재|포토레지스트|PR\b|머티리얼|웨이퍼|블랭크마스크|세라믹|실리콘|SiC|와이어|공정\s*부품|전자재료|식각|세정|코팅/i, '소재'],
    [/파운드리|파운드/i, '파운드리'],
    [/팹리스|디자인|IP\b|ASIC|MCU|SSD|컨트롤러|설계|비메모리|시스템반도체/i, '팹리스'],
    [/메모리|HBM|DRAM|NAND|삼성전자|SK하이닉스/i, 'IDM'],
    [/후공정/i, '후공정 장비'],
    [/장비|펌프|UV/i, '전공정 장비'],
  ],
  ship: [
  ...
  construction: [
    ...
    [/토지신탁|지주|holding|trust/i, '지주·기타'],
    [/건설|이앤씨|시공|토목|플랜트|E&C|contractor|construction/i, '종합건설'],
  ],
  auto: [
