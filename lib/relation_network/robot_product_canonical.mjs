...
export const ROBOT_FOCUS_BY_TICKER = {
  ...
  '437730': {
    lane: 'actuator_drive',
    products: [
      { id: 'actuator:axlon', nameKo: 'AXLON 휴머노이드 관절 액추에이터', nameEn: 'AXLON humanoid joint actuator', edge: 'produces_component' },
    ],
    categories: [
      { id: 'robot_category:actuator-module', nameKo: '액추에이터·모듈', nameEn: 'Actuator / module' },
    ],
    applications: [
      { id: 'application:humanoid', nameKo: '휴머노이드', nameEn: 'Humanoid' },
    ],
  },
  '058610': {
