...
export const NETWORK_PROFILES = {
  ...
  cosmetics: {
    ...
    layout: 'platformEcosystem',
    networkPath: null,
    defaultEdgeTypes: ['odm_for', 'oem_for', 'supplies_ingredient'],
    defaultDepth: 1,
...
export const PILOT_NETWORK_SECTORS = new Set(['semiconductor', 'holdings', 'defense', 'bio', 'bigchip', 'battery', 'ship', 'finance', 'powergrid', 'nuclear', 'renewable', 'construction', 'auto', 'elec', 'metal']);
