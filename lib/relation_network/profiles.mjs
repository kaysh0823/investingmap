...
export const NETWORK_PROFILES = {
  ...
  metal: {
    ...
    layout: 'layeredSupplyChain',
    networkPath: null,
    defaultEdgeTypes: ['supplies_material', 'customer', 'end_market_exposure'],
    defaultDepth: 1,
...
export const PILOT_NETWORK_SECTORS = new Set(['semiconductor', 'holdings', 'defense', 'bio', 'bigchip', 'battery', 'ship', 'finance', 'powergrid', 'nuclear', 'renewable', 'construction', 'auto', 'elec']);
