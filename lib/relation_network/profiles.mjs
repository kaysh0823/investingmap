...
export const NETWORK_PROFILES = {
  ...
  auto: {
    ...
    layout: 'layeredSupplyChain',
    networkPath: null,
    defaultEdgeTypes: ['supplies_oem', 'supplies_component'],
    defaultDepth: 1,
...
export const PILOT_NETWORK_SECTORS = new Set(['semiconductor', 'holdings', 'defense', 'bio', 'bigchip', 'battery', 'ship', 'finance', 'powergrid', 'nuclear', 'renewable', 'construction']);
