...
export const NETWORK_PROFILES = {
  ...
  medtech: {
    ...
    layout: 'assetLicensing',
    networkPath: null,
    defaultEdgeTypes: ['manufactures', 'distributes', 'supplies_to'],
    defaultDepth: 1,
...
export const PILOT_NETWORK_SECTORS = new Set(['semiconductor', 'holdings', 'defense', 'bio', 'bigchip', 'battery', 'ship', 'finance', 'powergrid', 'nuclear', 'renewable', 'construction', 'auto', 'elec', 'metal', 'cosmetics', 'kconsume', 'kcontent']);
