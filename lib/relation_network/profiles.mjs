...
export const NETWORK_PROFILES = {
  ...
  robot: {
    ...
    networkPath: null,
    defaultEdgeTypes: ['component_supplier', 'system_integrator', 'deployed_at'],
    defaultDepth: 1,
...
export const PILOT_NETWORK_SECTORS = new Set(['semiconductor', 'holdings', 'defense', 'bio', 'bigchip', 'battery', 'ship', 'finance', 'powergrid', 'nuclear', 'renewable', 'construction', 'auto', 'elec', 'metal', 'cosmetics', 'kconsume', 'kcontent', 'medtech', 'software', 'telecom']);
