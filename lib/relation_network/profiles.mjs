...
export const NETWORK_PROFILES = {
  ...
  kconsume: {
    ...
    layout: 'platformEcosystem',
    networkPath: null,
    defaultEdgeTypes: ['brand_owner', 'distributes', 'sells_through'],
    defaultDepth: 1,
  ...
  kcontent: {
    ...
    layout: 'platformEcosystem',
    networkPath: null,
    defaultEdgeTypes: ['owns_ip', 'produces', 'streams_on', 'distributes'],
    defaultDepth: 1,
...
export const PILOT_NETWORK_SECTORS = new Set(['semiconductor', 'holdings', 'defense', 'bio', 'bigchip', 'battery', 'ship', 'finance', 'powergrid', 'nuclear', 'renewable', 'construction', 'auto', 'elec', 'metal', 'cosmetics']);
