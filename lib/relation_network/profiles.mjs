...
export const NETWORK_PROFILES = {
  ...
  construction: {
    ...
    layout: 'projectEcosystem',
    networkPath: null,
    defaultEdgeTypes: ['main_contractor', 'subcontractor', 'project_owner'],
    defaultDepth: 1,
...
export const PILOT_NETWORK_SECTORS = new Set(['semiconductor', 'holdings', 'defense', 'bio', 'bigchip', 'battery', 'ship', 'finance', 'powergrid', 'nuclear', 'renewable']);
