...
export const NETWORK_PROFILES = {
  ...
  elec: {
    ...
    layout: 'layeredSupplyChain',
    networkPath: null,
    defaultEdgeTypes: ['component_supplier', 'module_supplier', 'customer'],
    defaultDepth: 1,
...
export const PILOT_NETWORK_SECTORS = new Set(['semiconductor', 'holdings', 'defense', 'bio', 'bigchip', 'battery', 'ship', 'finance', 'powergrid', 'nuclear', 'renewable', 'construction', 'auto']);
