...
export const NETWORK_PROFILES = {
  ...
  software: {
    ...
    networkPath: null,
    defaultEdgeTypes: ['cloud_partner', 'technology_integration', 'platform_dependency'],
    defaultDepth: 1,
  ...
  telecom: {
    ...
    layout: 'platformEcosystem',
    networkPath: null,
    defaultEdgeTypes: ['equipment_supplier', 'infrastructure_partner'],
    defaultDepth: 1,
...
export const PILOT_NETWORK_SECTORS = new Set(['semiconductor', 'holdings', 'defense', 'bio', 'bigchip', 'battery', 'ship', 'finance', 'powergrid', 'nuclear', 'renewable', 'construction', 'auto', 'elec', 'metal', 'cosmetics', 'kconsume', 'kcontent', 'medtech']);
