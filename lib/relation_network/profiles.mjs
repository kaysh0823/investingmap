...
export const NETWORK_PROFILES = {
  ...
  ship: {
    ...
    layers: ['종합조선', '엔진', '선체·보냉·구조재', '의장/배관', '서비스·해양플랜트'],
    lanes: [
      'shipowner',
      'order_contract',
      'shipyard',
  ...
  shipping: {
    ...
    defaultEdgeTypes: ['peer', 'member_of', 'exposed_to'],
    defaultDepth: 1,
    defaultViewFilters: {
      hidePeer: true,
      hideInferred: true,
    ...
    layers: ['해운물류'],
    lanes: ['shipping', 'ports', 'logistics'],
    roleAliases: { shipping: '해운물류', shipowner: '해운물류' },
  },
  bio: {
    sectorId: 'bio',
    dataSector: 'bio',
  ...
  machinery: {
    ...
    defaultEdgeTypes: ['peer', 'member_of', 'specializes_in'],
    defaultDepth: 1,
    defaultViewFilters: { transactionalOnly: false, hidePeer: true, hideInferred: true },
    lanes: ['construction_machinery', 'machine_tools', 'industrial_equipment', 'elevators'],
  ...
  chemical: {
    ...
    defaultEdgeTypes: [
      'member_of', 'specializes_in', 'produces', 'exposed_to_feedstock',
      'cross_sector_reference', 'supplies_chemical_to', 'operates_refinery',
      'owns_stake_in', 'peer',
    ],
    defaultDepth: 1,
    defaultViewFilters: { transactionalOnly: false, hidePeer: true, hideInferred: true },
    lanes: ['petrochemical', 'specialty_chemical', 'refining_gas', 'chemical_materials'],
  ...
  travel: {
    ...
    defaultEdgeTypes: [
      'member_of', 'specializes_in', 'produces', 'operates_service',
      'cross_sector_reference', 'operates_route', 'operates_property', 'codeshare_with',
      'owns_stake_in', 'peer',
    ],
    defaultDepth: 1,
    defaultViewFilters: { transactionalOnly: false, hidePeer: true, hideInferred: true },
    lanes: ['airlines', 'casino', 'hotel_resort', 'travel_duty_free'],
...
export const PILOT_NETWORK_SECTORS = new Set(['semiconductor', 'holdings', 'defense', 'bio', 'bigchip', 'battery', 'ship', 'finance', 'powergrid', 'nuclear', 'renewable', 'construction', 'auto', 'elec', 'metal', 'cosmetics', 'kconsume', 'kcontent', 'medtech', 'software', 'telecom', 'chemical', 'travel', 'robot']);
