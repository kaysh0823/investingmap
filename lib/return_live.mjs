...
export { isKrxRegularSession, isKrxTradingDay } from '../functions/lib/krx_session.mjs';

export function kstYmd(now = new Date()) {
  return kstYmdSession(now);
}

/** KRX recentDd is before KST trading-day anchor. */
...
/**
 * Overlay Naver/live 1D only on KRX trading days.
 * On weekends/holidays Naver reports 0% and would wipe KRX close-to-close.
 */
