...
const CACHE_BASE = '/api/ticker_ohlc/cache/v23';
...
export async function onRequest(context) {
  ...
  // Signature invalidates when history, price_adjustments, or investor_net min/max date changes.
