...
(function (global) {
  ...
  var HUB_CARD_TAGS = {
    ko: {
      ...
      defense: ['방산/우주/항공', '군용 항공', '미사일·C4ISR', '육상무기', '해군·함정', '우주·위성', '민항'],
    ...
    en: {
      ...
      defense: ['Defense, Space & Aviation', 'Military aviation', 'Missiles & C4ISR', 'Land systems', 'Naval', 'Space & satellites', 'Civil aviation'],
