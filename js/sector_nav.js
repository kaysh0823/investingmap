...
(function (global) {
  ...
  var SECTORS = [
    ...
    { id: 'elec', path: '../elec/korea_elec_map.html', ko: "전기·전자", en: "Electrical & Electronics" },
    ...
    { id: 'renewable', path: '../renewable/korea_renewable_map.html', ko: "신재생", en: "Renewable" },
    { id: 'nuclear', path: '../nuclear/korea_nuclear_map.html', ko: "원전", en: "Nuclear" },
    { id: 'powergrid', path: '../powergrid/korea_powergrid_map.html', ko: "전력설비", en: "Power Equip." },
    { id: 'chemical', path: '../chemical/korea_chemical_map.html', ko: "화학·정유", en: "Chemicals & Refining" },
    { id: 'metal', path: '../metal/korea_metal_map.html', ko: "철강·비철금속", en: "Steel & Nonferrous" },
    { id: 'machinery', path: '../machinery/korea_machinery_map.html', ko: "산업·건설기계", en: "Machinery" },
    { id: 'construction', path: '../construction/korea_construction_map.html', ko: "건설", en: "Construction" },
    { id: 'ship', path: '../ship/korea_ship_map.html', ko: "조선·기자재", en: "Shipbuilding & Equipment" },
    { id: 'defense', path: '../defense/korea_defense_map.html', ko: "방산/우주", en: "Defense & Space" },
    { id: 'shipping', path: '../shipping/korea_shipping_map.html', ko: "해운·물류", en: "Shipping & Logistics" },
    { id: 'travel', path: '../travel/korea_travel_map.html', ko: "여행·레저·항공", en: "Travel & Airlines" },
    ...
    { id: 'cosmetics', path: '../cosmetics/korea_cosmetics_map.html', ko: "화장품/미용기기", en: "Cosmetics" },
    { id: 'medtech', path: '../medtech/korea_medtech_map.html', ko: "의료기기/헬스케어", en: "MedTech" },
