...
(function (global) {
  ...
  var SECTOR_LABELS = {
    ...
    metal: { ko: "철강·비철금속", en: "Steel & Nonferrous" },
    machinery: { ko: "산업·건설기계", en: "Machinery" },
    construction: { ko: "건설", en: "Construction" },
    ship: { ko: "조선·기자재", en: "Shipbuilding & Equipment" },
    defense: { ko: "방산/우주", en: "Defense & Space" },
    shipping: { ko: "해운·물류", en: "Shipping & Logistics" },
    travel: { ko: "여행·레저·항공", en: "Travel & Airlines" },
    kconsume: { ko: "소비/유통", en: "Consumer/Retail" },
    kcontent: { ko: "콘텐츠", en: "K-Content" },
  ...
  function pathPrefix() {
    ...
    if (/\/(bigchip|semiconductor|bio|ship|shipping|defense|robot|auto|medtech|energy|battery|ess|renewable|nuclear|powergrid|kculture|kconsume|cosmetics|kcontent|finance|construction|software|holdings|telecom|chemical|travel|elec|metal|machinery)\//i.test(p)) {
      return '../';
    }
    return '';
  }
