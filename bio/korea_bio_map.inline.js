/* Generated by gen_korea_bio_inline.mjs -- do not edit */
    ...
    const koreanCompanies = [
...

      {
        ...
        sectorId: 'biosimilar',
        revenue: '43.76조원', mcapWon: 43755290805600, per: 38.89, pbr: 2.31, revTier: 3, partners: ['glob_207940', 'glob_4568t', 'glob_abbv']
      },

      {
        ...
        revenue: '20.10조원', mcapWon: 20095505870500, per: 127.03, pbr: 40.81, revTier: 3, partners: ['glob_lonn', 'glob_2269hk', 'glob_catalentnovoholdings']
      },

      {
        id: 'bio_3', name: '삼성에피스홀딩스', nameEn: 'Samsung Epis Holdings', ticker: '0126Z0', market: 'KOSPI', chain: '제약·바이오 지주',
        ...
        revenue: '8.86조원', mcapWon: 8858365444000, per: null, pbr: 1.92, revTier: 2, partners: []
      },

      {
        id: 'bio_4', name: 'SK바이오팜', nameEn: 'SK Biopharm', ticker: '326030', market: 'KOSPI', chain: '신약개발',
        semType: 'Drug discovery', semTypeEn: 'Drug discovery',
        ...
        sectorId: 'drug_discovery',
        revenue: '6.78조원', mcapWon: 6781927450000, per: 25.78, pbr: 8.47, revTier: 2, partners: ['glob_lonn', 'glob_2269hk', 'glob_catalentnovoholdings']
      },

      {
        ...
        revenue: '6.07조원', mcapWon: 6066004238500, per: 30.74, pbr: 4.17, revTier: 2, partners: ['glob_sdz', 'glob_amgn', 'glob_teva']
      },

      {
        ...
        sectorId: 'pharma_integrated',
        revenue: '5.99조원', mcapWon: 5992324573400, per: 29.7, pbr: 2.5, revTier: 2, partners: ['glob_sdz', 'glob_amgn', 'glob_teva']
      },

      {
        ...
        sectorId: 'drug_discovery',
        revenue: '4.50조원', mcapWon: 4495440026250, per: null, pbr: 14.59, revTier: 2, partners: ['glob_lonn', 'glob_2269hk', 'glob_catalentnovoholdings']
      },

      {
        id: 'bio_8', name: '에이비엘바이오', nameEn: 'ABL Bio', ticker: '298380', market: 'KOSDAQ', chain: '신약개발',
        semType: 'Drug discovery', semTypeEn: 'Drug discovery',
        products: 'Grabody-B/T: 사노피·GSK·릴리 빅3 L/O(누적10조), 이중항체ADC ABL206·209 \'26 IND', productsEn: 'Biotech and healthcare products and services',
        sectorId: 'drug_discovery',
        revenue: '4.00조원', mcapWon: 3997504858200, per: null, pbr: 32.45, revTier: 2, partners: ['glob_lonn', 'glob_2269hk', 'glob_catalentnovoholdings']
      },

      {
        id: 'bio_9', name: '삼천당제약', nameEn: 'Samchundang Pharm', ticker: '000250', market: 'KOSDAQ', chain: '종합 제약',
        semType: 'Integrated pharma', semTypeEn: 'Integrated pharma',
        products: 'GLP-1 비만치료제 파이프라인(SC·경구) · 펩타이드 · 비만·대사', productsEn: 'Biotech and healthcare products and services',
        sectorId: 'pharma_integrated',
        revenue: '3.68조원', mcapWon: 3682823104000, per: 1157.08, pbr: 22.03, revTier: 2, partners: ['glob_sdz', 'glob_amgn', 'glob_teva']
      },

      {
        id: 'bio_10', name: '펩트론', nameEn: 'Peptron, Inc.', ticker: '087010', market: 'KOSDAQ', chain: '신약개발',
        semType: 'Drug discovery', semTypeEn: 'Drug discovery',
        ...
        sectorId: 'drug_discovery',
        revenue: '3.67조원', mcapWon: 3667819155000, per: null, pbr: 37.64, revTier: 2, partners: ['glob_lonn', 'glob_2269hk', 'glob_catalentnovoholdings']
      },

      {
        id: 'bio_11', name: '한미사이언스', nameEn: 'Hanmi Science', ticker: '008930', market: 'KOSPI', chain: '제약·바이오 지주',
        ...
        sectorId: 'bio_holdings',
        revenue: '3.61조원', mcapWon: 3611073840000, per: 17.22, pbr: 2.12, revTier: 2, partners: []
      },

      {
        ...
        sectorId: 'drug_discovery',
        revenue: '3.41조원', mcapWon: 3405786456000, per: null, pbr: 9.27, revTier: 2, partners: ['glob_lonn', 'glob_2269hk', 'glob_catalentnovoholdings']
      },

      {
        id: 'bio_13', name: 'SK바이오사이언스', nameEn: 'SK Bioscience', ticker: '302440', market: 'KOSPI', chain: '백신·혈액제제',
        semType: 'Vaccines & blood products', semTypeEn: 'Vaccines & blood products',
        products: '스카이셀플루(세포배양 독감백신) 허가, mRNA 백신 CDMO + 자체 파이프라인', productsEn: 'Biotech and healthcare products and services',
        sectorId: 'vaccine_blood',
        revenue: '2.97조원', mcapWon: 2973503358700, per: null, pbr: 1.72, revTier: 2, partners: []
      },

      {
        id: 'bio_14', name: '한올바이오파마', nameEn: 'HanAll Biopharma', ticker: '009420', market: 'KOSPI', chain: '종합 제약',
        semType: 'Integrated pharma', semTypeEn: 'Integrated pharma',
        products: 'HL161 자가면역 항체 임상 진행, 롤론티스 공동판매, 한미약품 계열', productsEn: 'Biotech and healthcare products and services',
        sectorId: 'pharma_integrated',
        revenue: '2.86조원', mcapWon: 2857562898600, per: null, pbr: 16.17, revTier: 2, partners: ['glob_sdz', 'glob_amgn', 'glob_teva']
      },

      {
        id: 'bio_15', name: '보로노이', nameEn: 'Voronoi, Inc.', ticker: '310210', market: 'KOSDAQ', chain: '신약개발',
        semType: 'Drug discovery', semTypeEn: 'Drug discovery',
        ...
        sectorId: 'drug_discovery',
        revenue: '2.83조원', mcapWon: 2834102844000, per: null, pbr: 34.08, revTier: 2, partners: ['glob_lonn', 'glob_2269hk', 'glob_catalentnovoholdings']
      },

      {
        id: 'bio_16', name: '디앤디파마텍', nameEn: 'D&D Pharmatech', ticker: '347850', market: 'KOSDAQ', chain: '신약개발',
        semType: 'Drug discovery', semTypeEn: 'Drug discovery',
        ...
        sectorId: 'drug_discovery',
        revenue: '2.26조원', mcapWon: 2255210362800, per: null, pbr: 47.92, revTier: 2, partners: ['glob_lonn', 'glob_2269hk', 'glob_catalentnovoholdings']
      },

      {
        id: 'bio_17', name: '에스티팜', nameEn: 'ST Pharm', ticker: '237690', market: 'KOSDAQ', chain: 'CDMO·CMO',
        semType: 'CDMO / CMO', semTypeEn: 'CDMO / CMO',
        products: '올리고뉴클레오타이드 합성 플랫폼', productsEn: 'Biotech and healthcare products and services',
        sectorId: 'cdmo',
        revenue: '2.11조원', mcapWon: 2112715765600, per: 45.08, pbr: 4.26, revTier: 2, partners: []
      },

      {
        id: 'bio_18', name: '올릭스', nameEn: 'Olix Pharmaceuticals, Inc.', ticker: '226950', market: 'KOSDAQ', chain: '신약개발',
        semType: 'Drug discovery', semTypeEn: 'Drug discovery',
        ...
        sectorId: 'drug_discovery',
        revenue: '2.02조원', mcapWon: 2019927315000, per: null, pbr: 17.1, revTier: 2, partners: ['glob_lonn', 'glob_2269hk', 'glob_catalentnovoholdings']
      },

      {
        id: 'bio_19', name: '메지온', nameEn: 'Mezzion Pharma Co., Ltd.', ticker: '140410', market: 'KOSDAQ', chain: '신약개발',
        semType: '신약개발', semTypeEn: 'Drug Development',
        products: '항암·면역 등 신약 파이프라인', productsEn: 'Oncology and immunology drug pipeline',
        sectorId: 'drug_discovery',
        revenue: '1.99조원', mcapWon: 1990408810000, per: null, pbr: 114.31, revTier: 2, partners: ['glob_lonn', 'glob_2269hk', 'glob_catalentnovoholdings']
      },

      {
        id: 'bio_20', name: '셀트리온제약', nameEn: 'Celltrion Pharm', ticker: '068760', market: 'KOSDAQ', chain: '종합 제약',
        semType: 'Integrated pharma', semTypeEn: 'Integrated pharma',
        products: '셀트리온 합병법인 국내유통, 짐펜트라(자가면역SC) \'26 美매출 급성장 기대', productsEn: 'Biotech and healthcare products and services',
        sectorId: 'pharma_integrated',
        revenue: '1.81조원', mcapWon: 1813835262200, per: 49.03, pbr: 4.36, revTier: 2, partners: ['glob_sdz', 'glob_amgn', 'glob_teva']
      },

      {
        id: 'bio_21', name: '네이처셀', nameEn: 'NATURECELL CO.,LTD.', ticker: '007390', market: 'KOSDAQ', chain: '신약개발',
        ...
        sectorId: 'drug_discovery',
        revenue: '1.54조원', mcapWon: 1543219591200, per: null, pbr: 32.72, revTier: 2, partners: ['glob_lonn', 'glob_2269hk', 'glob_catalentnovoholdings']
      },

      {
        id: 'bio_22', name: '에임드바이오', nameEn: 'Aimed Bio Inc.', ticker: '0009K0', market: 'KOSDAQ', chain: '신약개발',
        semType: 'Drug discovery', semTypeEn: 'Drug discovery',
        ...
        sectorId: 'drug_discovery',
        revenue: '1.52조원', mcapWon: 1516538725450, per: 251.85, pbr: 9.06, revTier: 2, partners: ['glob_lonn', 'glob_2269hk', 'glob_catalentnovoholdings']
      },

      {
        id: 'bio_23', name: '녹십자', nameEn: 'GC Biopharma', ticker: '006280', market: 'KOSPI', chain: '백신·혈액제제',
        semType: 'Vaccines & blood products', semTypeEn: 'Vaccines & blood products',
        products: '알리글로 美FDA허가·출시, 면역글로불린 美매출 1500억+돌파(\'25), 글로벌 시장 확대', productsEn: 'Biotech and healthcare products and services',
        sectorId: 'vaccine_blood',
        revenue: '1.49조원', mcapWon: 1491202248800, per: null, pbr: 1.18, revTier: 2, partners: []
      },

      {
        ...
        sectorId: 'drug_discovery',
        revenue: '1.45조원', mcapWon: 1452989736000, per: null, pbr: null, revTier: 2, partners: ['glob_lonn', 'glob_2269hk', 'glob_catalentnovoholdings']
      },

      {
        id: 'bio_25', name: '오스코텍', nameEn: 'OSCOTEC Inc.', ticker: '039200', market: 'KOSDAQ', chain: '신약개발',
        semType: 'Drug discovery', semTypeEn: 'Drug discovery',
        products: '신약개발', productsEn: 'Biotech and healthcare products and services',
        sectorId: 'drug_discovery',
        revenue: '1.40조원', mcapWon: 1400249241600, per: 28.58, pbr: 8.25, revTier: 2, partners: ['glob_lonn', 'glob_2269hk', 'glob_catalentnovoholdings']
      },

      {
        id: 'bio_26', name: '대웅제약', nameEn: 'Daewoongpharmaceutical', ticker: '069620', market: 'KOSPI', chain: '종합 제약',
        semType: 'Integrated pharma', semTypeEn: 'Integrated pharma',
        products: '나보타(보톡스), 펙수클루 등', productsEn: 'Biotech and healthcare products and services',
        sectorId: 'pharma_integrated',
        relations: [{"relationId":"aesthetic-bio","type":"제품연관","label":"에스테틱↔바이오(톡신·재생)","chip":"연관","chipEn":"Related","ticker":"145020","name":"휴젤","nameEn":"Hugel, Inc.","sector":"cosmetics","map":"cosmetics/korea_cosmetics_map.html"},{"relationId":"aesthetic-bio","type":"제품연관","label":"에스테틱↔바이오(톡신·재생)","chip":"연관","chipEn":"Related","ticker":"086900","name":"메디톡스","nameEn":"Medytox","sector":"cosmetics","map":"cosmetics/korea_cosmetics_map.html"},{"relationId":"aesthetic-bio","type":"제품연관","label":"에스테틱↔바이오(톡신·재생)","chip":"연관","chipEn":"Related","ticker":"214450","name":"파마리서치","nameEn":"Pharma Research","sector":"cosmetics","map":"cosmetics/korea_cosmetics_map.html"}],
        revenue: '1.35조원', mcapWon: 1345201357500, per: 7.06, pbr: 1.37, revTier: 2, partners: ['glob_sdz', 'glob_amgn', 'glob_teva']
      },

      {
        id: 'bio_27', name: '오름테라퓨틱', nameEn: 'Orum Therapeutics', ticker: '475830', market: 'KOSDAQ', chain: '신약개발',
        semType: 'Drug discovery', semTypeEn: 'Drug discovery',
        ...
        sectorId: 'drug_discovery',
        revenue: '1.21조원', mcapWon: 1214125081000, per: null, pbr: 11.01, revTier: 2, partners: ['glob_lonn', 'glob_2269hk', 'glob_catalentnovoholdings']
      },

      {
        id: 'bio_28', name: 'HK이노엔', nameEn: 'HK inno.N Corporation', ticker: '195940', market: 'KOSDAQ', chain: '종합 제약',
        semType: '바이오·제약', semTypeEn: 'Biotech & Pharma',
        products: '바이오의약품·제네릭 (HK이노엔)', productsEn: 'Biologics and generics (HK Inno.N)',
        sectorId: 'pharma_integrated',
        revenue: '1.19조원', mcapWon: 1191271916550, per: 15.61, pbr: 0.89, revTier: 2, partners: ['glob_sdz', 'glob_amgn', 'glob_teva']
      },

      {
        id: 'bio_29', name: '대웅', nameEn: 'Daewoong', ticker: '003090', market: 'KOSPI', chain: '제약·바이오 지주',
        semType: 'Pharma / biotech holdings', semTypeEn: 'Pharma / biotech holdings',
        products: '제약 지주', productsEn: 'Biotech and healthcare products and services',
        sectorId: 'bio_holdings',
        revenue: '0.98조원', mcapWon: 980273782800, per: 4.23, pbr: 0.64, revTier: 1, partners: []
      },

      {
        id: 'bio_30', name: '동국제약', nameEn: 'DongKook Pharmaceutical Co.,Ltd.', ticker: '086450', market: 'KOSDAQ', chain: '종합 제약',
        semType: 'Integrated pharma', semTypeEn: 'Integrated pharma',
        products: '제약·헬스케어', productsEn: 'Biotech and healthcare products and services',
        sectorId: 'pharma_integrated',
        revenue: '0.98조원', mcapWon: 976977072000, per: 12.9, pbr: 1.3, revTier: 1, partners: ['glob_sdz', 'glob_amgn', 'glob_teva']
      },

      {
        id: 'bio_31', name: '종근당', nameEn: 'Chong Kun Dang', ticker: '185750', market: 'KOSPI', chain: '종합 제약',
        semType: 'Integrated pharma', semTypeEn: 'Integrated pharma',
        products: '제네릭 강자 + 신약 R&D 투자 확대', productsEn: 'Biotech and healthcare products and services',
        sectorId: 'pharma_integrated',
        revenue: '0.94조원', mcapWon: 938589040000, per: 12.04, pbr: 0.93, revTier: 1, partners: ['glob_sdz', 'glob_amgn', 'glob_teva']
      },

      {
        id: 'bio_32', name: '큐리언트', nameEn: 'Qurient Co., Ltd.', ticker: '115180', market: 'KOSDAQ', chain: '신약개발',
        semType: '세포치료·바이오', semTypeEn: 'Cell Therapy & Biotech',
        products: '세포·유전자치료·바이오 R&D', productsEn: 'Cell and gene therapy biotech R&D',
        sectorId: 'drug_discovery',
        revenue: '0.87조원', mcapWon: 865162180550, per: null, pbr: 28.1, revTier: 1, partners: ['glob_lonn', 'glob_2269hk', 'glob_catalentnovoholdings']
      },

      {
        id: 'bio_33', name: '큐리옥스바이오시스템즈', nameEn: 'Curiox Biosystems Co., Ltd.', ticker: '445680', market: 'KOSDAQ', chain: '연구도구·서비스',
        semType: '세포 처리·분석 자동화 장비', semTypeEn: 'Cell-processing Automation',
        products: '세포 전처리·분석 자동화 장비(연구도구)', productsEn: 'Cell sample-prep and analysis automation (research tools)',
        sectorId: 'research_tools',
        revenue: '0.82조원', mcapWon: 820127355550, per: null, pbr: 22.34, revTier: 1, partners: []
      },

      {
        id: 'bio_34', name: '알지노믹스', nameEn: 'Rznomics Inc.', ticker: '476830', market: 'KOSDAQ', chain: '신약개발',
        semType: 'Drug discovery', semTypeEn: 'Drug discovery',
        products: 'RNAi·RNA 치료제 플랫폼', productsEn: 'Biotech and healthcare products and services',
        sectorId: 'drug_discovery',
        revenue: '0.79조원', mcapWon: 791163295200, per: null, pbr: 21.85, revTier: 1, partners: ['glob_lonn', 'glob_2269hk', 'glob_catalentnovoholdings']
      },

      {
        id: 'bio_35', name: '보령', nameEn: 'Boryung', ticker: '003850', market: 'KOSPI', chain: '종합 제약',
        semType: 'Integrated pharma', semTypeEn: 'Integrated pharma',
        products: '제약', productsEn: 'Biotech and healthcare products and services',
        sectorId: 'pharma_integrated',
        revenue: '0.78조원', mcapWon: 775516351280, per: 11.36, pbr: 0.87, revTier: 1, partners: ['glob_sdz', 'glob_amgn', 'glob_teva']
      },

      {
        id: 'bio_36', name: '인제니아테라퓨틱스(Reg.S)', nameEn: '인제니아테라퓨틱스(Reg.S)', ticker: '950260', market: 'KOSDAQ', chain: '신약개발',
        semType: '망막질환 신약', semTypeEn: 'Retinal disease therapeutics',
        products: '망막질환 신약개발', productsEn: 'Retinal disease drug development',
        sectorId: 'smallmol',
        revenue: '0.77조원', mcapWon: 770346977060, per: null, pbr: null, revTier: 1, partners: []
      },

      {
        id: 'bio_37', name: '차바이오텍', nameEn: 'Cha Biotech', ticker: '085660', market: 'KOSDAQ', chain: '제약·바이오 지주',
        semType: 'Pharma / biotech holdings', semTypeEn: 'Pharma / biotech holdings',
        products: '줄기세포(면역세포) 치료제, 세포배양 · 세포치료', productsEn: 'Biotech and healthcare products and services',
        sectorId: 'bio_holdings',
        revenue: '0.75조원', mcapWon: 752150324140, per: null, pbr: 3.18, revTier: 1, partners: []
      },

      {
        id: 'bio_38', name: '온코닉테라퓨틱스', nameEn: 'Onconic Therapeutics Inc.', ticker: '476060', market: 'KOSDAQ', chain: '신약개발',
        semType: 'Drug discovery', semTypeEn: 'Drug discovery',
        products: '항암·면역치료 신약 파이프라인', productsEn: 'Biotech and healthcare products and services',
        sectorId: 'drug_discovery',
        revenue: '0.75조원', mcapWon: 746504889600, per: 43.76, pbr: 9.7, revTier: 1, partners: ['glob_lonn', 'glob_2269hk', 'glob_catalentnovoholdings']
      },

      {
        id: 'bio_39', name: '코미팜', nameEn: 'KOMIPHARM INTERNATIONAL CO., LTD.', ticker: '041960', market: 'KOSDAQ', chain: '종합 제약',
        semType: 'Integrated pharma', semTypeEn: 'Integrated pharma',
        products: '동물약품·바이오', productsEn: 'Biotech and healthcare products and services',
        sectorId: 'pharma_integrated',
        revenue: '0.72조원', mcapWon: 717437866450, per: null, pbr: 8.85, revTier: 1, partners: ['glob_sdz', 'glob_amgn', 'glob_teva']
      },

      {
        id: 'bio_40', name: '명인제약', nameEn: 'MYUNGIN PHARM', ticker: '317450', market: 'KOSPI', chain: '종합 제약',
        semType: 'Integrated pharma', semTypeEn: 'Integrated pharma',
        products: '정신과·전문의약품', productsEn: 'Biotech and healthcare products and services',
        sectorId: 'pharma_integrated',
        revenue: '0.65조원', mcapWon: 651890000000, per: 6.45, pbr: 0.8, revTier: 1, partners: ['glob_sdz', 'glob_amgn', 'glob_teva']
      },

      {
        id: 'bio_41', name: 'JW중외제약', nameEn: 'JW Pharmaceutical', ticker: '001060', market: 'KOSPI', chain: '종합 제약',
        semType: 'Integrated pharma', semTypeEn: 'Integrated pharma',
        products: '리바로·리바넥스, 개량신약', productsEn: 'Biotech and healthcare products and services',
        sectorId: 'pharma_integrated',
        revenue: '0.64조원', mcapWon: 640363075000, per: 10.67, pbr: 1.77, revTier: 1, partners: ['glob_sdz', 'glob_amgn', 'glob_teva']
      },

      {
        id: 'bio_42', name: '지투지바이오', nameEn: 'G2GBIO, Inc.', ticker: '456160', market: 'KOSDAQ', chain: '신약개발',
        semType: 'Drug discovery', semTypeEn: 'Drug discovery',
        products: '장기지속형 주사·약물전달', productsEn: 'Biotech and healthcare products and services',
        sectorId: 'drug_discovery',
        revenue: '0.63조원', mcapWon: 631086716700, per: null, pbr: 12.76, revTier: 1, partners: ['glob_lonn', 'glob_2269hk', 'glob_catalentnovoholdings']
      },

      {
        id: 'bio_43', name: '파미셀', nameEn: 'Pharmicell', ticker: '005690', market: 'KOSPI', chain: '원료의약품·생산소재',
        semType: 'API & production materials', semTypeEn: 'API & production materials',
        products: '줄기세포치료·원료의약품', productsEn: 'Biotech and healthcare products and services',
        sectorId: 'api_materials',
        revenue: '0.63조원', mcapWon: 630042147000, per: 21.89, pbr: 7.12, revTier: 1, partners: []
      },

      {
        id: 'bio_44', name: '동아쏘시오홀딩스', nameEn: 'Dong-A Socio Holdings', ticker: '000640', market: 'KOSPI', chain: '제약·바이오 지주',
        semType: 'Pharma / biotech holdings', semTypeEn: 'Pharma / biotech holdings',
        products: '제약 지주', productsEn: 'Biotech and healthcare products and services',
        sectorId: 'bio_holdings',
        revenue: '0.62조원', mcapWon: 623432000200, per: 5.98, pbr: 0.48, revTier: 1, partners: []
      },

      {
        id: 'bio_45', name: '현대바이오', nameEn: 'HYUNDAI BIOSCIENCE CO., LTD.', ticker: '048410', market: 'KOSDAQ', chain: '신약개발',
        semType: 'Drug discovery', semTypeEn: 'Drug discovery',
        products: '항바이러스·항암 치료제 · 저분자 · 감염', productsEn: 'Biotech and healthcare products and services',
        sectorId: 'drug_discovery',
        revenue: '0.60조원', mcapWon: 599299602120, per: null, pbr: 7.73, revTier: 1, partners: ['glob_lonn', 'glob_2269hk', 'glob_catalentnovoholdings']
      },

      {
        id: 'bio_46', name: '에스티큐브', nameEn: 'Stcube', ticker: '052020', market: 'KOSDAQ', chain: '신약개발',
        semType: 'Drug discovery', semTypeEn: 'Drug discovery',
        products: '면역관문·항암 신약 · 항체', productsEn: 'Biotech and healthcare products and services',
        sectorId: 'drug_discovery',
        revenue: '0.55조원', mcapWon: 547265492550, per: null, pbr: 10.36, revTier: 1, partners: ['glob_lonn', 'glob_2269hk', 'glob_catalentnovoholdings']
      },

      {
        id: 'bio_47', name: '신풍제약', nameEn: 'Shinpoong Pharmaceutical', ticker: '019170', market: 'KOSPI', chain: '종합 제약',
        semType: '제약', semTypeEn: 'Pharmaceuticals',
        products: '전문의약품·원료의약품', productsEn: 'Specialty pharma and APIs',
        sectorId: 'pharma_integrated',
        revenue: '0.52조원', mcapWon: 524709405220, per: 52.73, pbr: 1.72, revTier: 1, partners: ['glob_sdz', 'glob_amgn', 'glob_teva']
      },

      {
        id: 'bio_48', name: '지아이이노베이션', nameEn: 'GI Innovation Inc.', ticker: '358570', market: 'KOSDAQ', chain: '신약개발',
        semType: 'Drug discovery', semTypeEn: 'Drug discovery',
        products: '면역·알레르기 질환 신약 · 항체 · 자가면역', productsEn: 'Biotech and healthcare products and services',
        sectorId: 'drug_discovery',
        revenue: '0.52조원', mcapWon: 521934488540, per: null, pbr: 6.51, revTier: 1, partners: ['glob_lonn', 'glob_2269hk', 'glob_catalentnovoholdings']
      },

      {
        id: 'bio_49', name: '에이프릴바이오', nameEn: 'AprilBio Co.,Ltd.', ticker: '397030', market: 'KOSDAQ', chain: '신약개발',
        semType: 'Drug discovery', semTypeEn: 'Drug discovery',
        products: '항체·이중항체 신약 플랫폼', productsEn: 'Biotech and healthcare products and services',
        sectorId: 'drug_discovery',
        revenue: '0.49조원', mcapWon: 490546319600, per: null, pbr: 9.99, revTier: 1, partners: ['glob_lonn', 'glob_2269hk', 'glob_catalentnovoholdings']
      },

      {
        id: 'bio_50', name: '일동제약', nameEn: 'ILDONG PHARM', ticker: '249420', market: 'KOSPI', chain: '종합 제약',
        semType: '제약', semTypeEn: 'Pharmaceuticals',
        products: '전문의약품·OTC·제네릭 (일동제약)', productsEn: 'Specialty, OTC and generic pharmaceuticals',
        sectorId: 'pharma_integrated',
        revenue: '0.48조원', mcapWon: 475522927560, per: 20.46, pbr: 2.46, revTier: 1, partners: ['glob_sdz', 'glob_amgn', 'glob_teva']
      },

      {
        id: 'bio_51', name: '녹십자홀딩스', nameEn: 'GC Corp.', ticker: '005250', market: 'KOSPI', chain: '제약·바이오 지주',
        semType: 'Pharma / biotech holdings', semTypeEn: 'Pharma / biotech holdings',
        products: '바이오 지주', productsEn: 'Biotech and healthcare products and services',
        sectorId: 'bio_holdings',
        revenue: '0.47조원', mcapWon: 465579279000, per: null, pbr: 0.54, revTier: 1, partners: []
      },

      {
        id: 'bio_52', name: '앱클론', nameEn: 'AbClon Inc.', ticker: '174900', market: 'KOSDAQ', chain: '신약개발',
        semType: '항체·바이오', semTypeEn: 'Antibody Biotech',
        products: '항체·바이오의약품 R&D', productsEn: 'Antibody and biologics R&D',
        sectorId: 'drug_discovery',
        revenue: '0.43조원', mcapWon: 430965986400, per: null, pbr: 10.09, revTier: 1, partners: ['glob_lonn', 'glob_2269hk', 'glob_catalentnovoholdings']
      },

      {
        id: 'bio_53', name: '부광약품', nameEn: 'Bukwang Pharmaceutical', ticker: '003000', market: 'KOSPI', chain: '종합 제약',
        semType: 'Integrated pharma', semTypeEn: 'Integrated pharma',
        products: '제약', productsEn: 'Biotech and healthcare products and services',
        sectorId: 'pharma_integrated',
        revenue: '0.40조원', mcapWon: 402551857680, per: 29.44, pbr: 1.3, revTier: 1, partners: ['glob_sdz', 'glob_amgn', 'glob_teva']
      },

      {
        id: 'bio_54', name: '프레스티지바이오파마', nameEn: 'Prestige BioPharma', ticker: '950210', market: 'KOSPI', chain: '바이오시밀러',
        semType: 'Biosimilars', semTypeEn: 'Biosimilars',
        ...
        sectorId: 'biosimilar',
        revenue: '0.39조원', mcapWon: 390625007500, per: null, pbr: null, revTier: 1, partners: ['glob_207940', 'glob_4568t', 'glob_abbv']
      },

      {
        id: 'bio_55', name: '페니트리움바이오', nameEn: 'PenetriumBio', ticker: '187660', market: 'KOSDAQ', chain: '신약개발',
        semType: '세포·유전자 신약', semTypeEn: 'Cell/gene therapeutics',
        products: '세포·유전자 신약개발', productsEn: 'Cell and gene therapy development',
        sectorId: 'smallmol',
        revenue: '0.37조원', mcapWon: 374202580050, per: null, pbr: 15.95, revTier: 1, partners: []
      },

      {
        id: 'bio_56', name: '큐로셀', nameEn: 'Curocell', ticker: '372320', market: 'KOSDAQ', chain: '신약개발',
        semType: '신약개발·세포치료', semTypeEn: 'Drug discovery & cell therapy',
        products: 'CAR-T·세포치료 파이프라인 · 항암', productsEn: 'CAR-T and cell therapy pipeline',
        sectorId: 'drug_discovery',
        revenue: '0.37조원', mcapWon: 366213005600, per: null, pbr: 82.76, revTier: 1, partners: ['glob_lonn', 'glob_2269hk', 'glob_catalentnovoholdings']
      },

      {
        id: 'bio_57', name: '동아에스티', nameEn: 'Dong-A ST', ticker: '170900', market: 'KOSPI', chain: '종합 제약',
        semType: 'Integrated pharma', semTypeEn: 'Integrated pharma',
        products: '슈가논·스티렌, R&D 비율 19%+ 업계 상위권, AI 신약탐색 확대', productsEn: 'Biotech and healthcare products and services',
        sectorId: 'pharma_integrated',
        revenue: '0.36조원', mcapWon: 359445202950, per: null, pbr: 0.55, revTier: 1, partners: ['glob_sdz', 'glob_amgn', 'glob_teva']
      },

      {
        id: 'bio_58', name: '인벤티지랩', nameEn: 'Inventage Lab Inc.', ticker: '389470', market: 'KOSDAQ', chain: '신약개발',
        semType: 'Drug discovery', semTypeEn: 'Drug discovery',
        products: '약물전달·DDS 플랫폼', productsEn: 'Biotech and healthcare products and services',
        sectorId: 'drug_discovery',
        revenue: '0.36조원', mcapWon: 356646574400, per: null, pbr: 8.69, revTier: 1, partners: ['glob_lonn', 'glob_2269hk', 'glob_catalentnovoholdings']
      },

      {
        id: 'bio_59', name: '메디포스트', nameEn: 'MEDIPOST CO., LTD.', ticker: '078160', market: 'KOSDAQ', chain: '신약개발',
        semType: 'Drug discovery', semTypeEn: 'Drug discovery',
        products: '카티스템(연골줄기세포) 허가 품목 · 세포치료', productsEn: 'Biotech and healthcare products and services',
        sectorId: 'drug_discovery',
        revenue: '0.35조원', mcapWon: 349705058760, per: null, pbr: 1.6, revTier: 1, partners: ['glob_lonn', 'glob_2269hk', 'glob_catalentnovoholdings']
      },

      {
        id: 'bio_60', name: '프로티나', nameEn: 'PROTEINA CO., LTD.', ticker: '468530', market: 'KOSDAQ', chain: '연구도구·서비스',
        ...
        sectorId: 'research_tools',
        revenue: '0.34조원', mcapWon: 341483301000, per: null, pbr: 13.18, revTier: 1, partners: []
      },

      {
        id: 'bio_61', name: '신라젠', nameEn: 'SillaJen, Inc.', ticker: '215600', market: 'KOSDAQ', chain: '신약개발',
        semType: 'Drug discovery', semTypeEn: 'Drug discovery',
        products: '온코리틱 바이러스·항암바이러스 · 유전자치료', productsEn: 'Biotech and healthcare products and services',
        sectorId: 'drug_discovery',
        revenue: '0.33조원', mcapWon: 327679178860, per: null, pbr: 3.2, revTier: 1, partners: ['glob_lonn', 'glob_2269hk', 'glob_catalentnovoholdings']
      },

      {
        id: 'bio_62', name: '유바이오로직스', nameEn: 'EuBiologics Co., Ltd.', ticker: '206650', market: 'KOSDAQ', chain: '백신·혈액제제',
        semType: '바이오의약품', semTypeEn: 'Biologics',
        products: '바이오의약품·CDMO', productsEn: 'Biologics and CDMO services',
        sectorId: 'vaccine_blood',
        revenue: '0.32조원', mcapWon: 323052778530, per: 8.39, pbr: 1.98, revTier: 1, partners: []
      },

      {
        id: 'bio_63', name: '툴젠', nameEn: 'ToolGen Incorporated', ticker: '199800', market: 'KOSDAQ', chain: '신약개발',
        semType: 'Drug discovery', semTypeEn: 'Drug discovery',
        products: '유전자가위(CRISPR) 원천기술 보유 · 유전자치료', productsEn: 'Biotech and healthcare products and services',
        sectorId: 'drug_discovery',
        revenue: '0.32조원', mcapWon: 320315592400, per: null, pbr: 7.18, revTier: 1, partners: ['glob_lonn', 'glob_2269hk', 'glob_catalentnovoholdings']
      },

      {
        id: 'bio_64', name: '광동제약', nameEn: 'Kwangdong Pharmaceutical', ticker: '009290', market: 'KOSPI', chain: '종합 제약',
        semType: 'Integrated pharma', semTypeEn: 'Integrated pharma',
        products: '제약·헬스케어', productsEn: 'Biotech and healthcare products and services',
        sectorId: 'pharma_integrated',
        revenue: '0.32조원', mcapWon: 315730782720, per: 12.25, pbr: 0.48, revTier: 1, partners: ['glob_sdz', 'glob_amgn', 'glob_teva']
      },

      {
        id: 'bio_65', name: '휴온스글로벌', nameEn: 'Huons Global Co., Ltd.', ticker: '084110', market: 'KOSDAQ', chain: '제약·바이오 지주',
        semType: 'Pharma / biotech holdings', semTypeEn: 'Pharma / biotech holdings',
        products: '제약 지주', productsEn: 'Biotech and healthcare products and services',
        sectorId: 'bio_holdings',
        revenue: '0.30조원', mcapWon: 301303525600, per: 11.55, pbr: 0.61, revTier: 1, partners: []
      }
