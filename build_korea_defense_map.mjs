...
const SEED = [
  ...
  },
  {
    ...
    chain: S.D4,
    semType: '\uAD6D\uBC29\uD568\uC815\u00B7\uC784\uC218\uC815\u00B7\uC870\uC120',
    semTypeEn: 'Naval vessels, submarines & shipbuilding',
    products: 'KSS-III, \uD574\uAD70\uD568\uC815, LNG\uC120',
    productsEn: 'KSS-III subs, naval surface ships, LNG carriers',
    partners: [
      'lockheed', 'bae',
      { id: 'exp_poland', kind: 'export', edgeLabel: '\uC791\uC804\u00B7\uC218\uC9C1\uC815 \uC218\uCD9C(\uCC38\uACE0)', edgeLabelEn: 'Frigate export (illus.)', weight: 0.08 },
    ],
  },
  {
    id: 'hd_ksoe',
    name: 'HD\uD55C\uAD6D\uC870\uC120\uD574\uC591',
    nameEn: 'HD Korea Shipbuilding & Offshore',
    ticker: '009540',
    chain: S.D4,
    semType: '\uAD6D\uBC29\u00B7\uC0C1\uC6A9 \uC870\uC120\u00B7\uD574\uC591\uC5D4\uC9C0\uB2C8\uC5B4\uB9C1',
    semTypeEn: 'Naval & commercial shipbuilding, offshore',
    products: '\uAD6D\uBC29\uC870\uC120, \uC5B4\uB4DC\uC0AC\uC774\uB4DC \uC720\uB2C8\uD2B8',
    productsEn: 'Defense yards, offshore & special ships',
    partners: ['bae', 'lockheed'],
  },
  {
    id: 'satrec',
