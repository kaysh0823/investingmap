...
const CHAINS = ['종합조선', '엔진', '의장/배관', '기타 기자재', '서비스·해양플랜트', '해운물류'];
...
const RETIRED_CHAINS = ['조선기자재', '해양플랜트', '방산해양', '철강소재'];
const CHAIN_COLORS = {
  종합조선: '#4FC3F7',
  엔진: '#66BB6A',
  '의장/배관': '#26C6DA',
...
const ANGLE = "{ '종합조선': 0, '엔진': 60, '의장/배관': 120, '기타 기자재': 180, '서비스·해양플랜트': 240, '해운물류': 300 }";
