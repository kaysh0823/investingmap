...
const SECTOR_MAPS = {
  ...
  machinery: {
    path: 'machinery/korea_machinery_map.html',
    additions: 'machinery/cp_list_machinery_additions.json',
    idPrefix: 'machinery',
  },
  elec: {
  ...
  auto: {
    ...
    extraChains: {
      '구동·파워트레인': { color: '#66BB6A', labelEn: 'Drivetrain & powertrain' },
      '섀시·안전': { color: '#EF5350', labelEn: 'Chassis & safety' },
      '차체·내외장': { color: '#8D6E63', labelEn: 'Body & interior/exterior' },
      '전장·차량 소프트웨어': { color: '#AB47BC', labelEn: 'Electronics & vehicle software' },
      열관리: { color: '#26C6DA', labelEn: 'Thermal management' },
      '유통·모빌리티 서비스': { color: '#78909C', labelEn: 'Distribution & mobility services' },
    },
    globalAdditions: [
  ...
  shipping: {
    path: 'shipping/korea_shipping_map.html',
    additions: 'shipping/cp_list_shipping_additions.json',
    idPrefix: 'shipping',
    chainOrder: [
      '컨테이너 해운',
      '벌크 해운',
    ...
    legendFirstChain: '컨테이너 해운',
    extraChains: {
      '컨테이너 해운': { color: '#42A5F5', labelEn: 'Container shipping' },
      '벌크 해운': { color: '#8D6E63', labelEn: 'Bulk shipping' },
      '탱커·가스 운송': { color: '#FFA726', labelEn: 'Tanker & gas transport' },
      '자동차·특수화물 운송': { color: '#26A69A', labelEn: 'Auto & special cargo' },
      종합물류: { color: '#5C6BC0', labelEn: 'Integrated logistics' },
      '택배·풀필먼트': { color: '#66BB6A', labelEn: 'Parcel & fulfillment' },
      '포워딩·국제물류': { color: '#AB47BC', labelEn: 'Forwarding & intl logistics' },
      '항만·터미널': { color: '#78909C', labelEn: 'Ports & terminals' },
    },
  },
  telecom: {
  ...
  powergrid: {
    ...
    additions: 'powergrid/cp_list_powergrid_additions.json',
    idPrefix: 'powergrid',
  },
  chemical: {
