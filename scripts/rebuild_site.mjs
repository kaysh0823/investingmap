...
run('node scripts/apply_p1a_cross_memberships.mjs', 'P1-A CROSS 028260/034020 additions+overrides');
...
run('node scripts/apply_cross_sector_memberships.mjs', 'verify SECTOR_CROSS policy (approved multi-home)');
...
run('node scripts/apply_mobility_04c_chain_reclass.mjs', 'mobility §0-4C auto/ship/shipping/defense chains');
run('node scripts/apply_tech_04d_chain_reclass.mjs', 'tech §0-4D elec/software/telecom/robot chains');
...
run('node scripts/apply_finance_04g_chain_reclass.mjs', 'finance §0-4G finance/holdings + Kakao Pay cross');
