...
const TARGETS = [
  { file: 'index.html', insert: 'js/return_live.js?v=1', before: 'js/hub_dashboard.js' },
  { file: 'semiconductor/korea_semiconductor_map.html', insert: '../js/return_live.js?v=1', before: '../js/live_quotes.js' },
  { file: 'energy/korea_energy_map.html', insert: '../js/return_live.js?v=1', before: '../js/live_quotes.js' },
  { file: 'powergrid/korea_powergrid_map.html', insert: '../js/return_live.js?v=1', before: '../js/live_quotes.js' },
  { file: 'ship/korea_ship_map.html', insert: '../js/return_live.js?v=1', before: '../js/live_quotes.js' },
  { file: 'defense/korea_defense_map.html', insert: '../js/return_live.js?v=1', before: '../js/live_quotes.js' },
  { file: 'kculture/korea_kculture_map.html', insert: '../js/return_live.js?v=1', before: '../js/live_quotes.js' },
