/**
 * Dual labels: 1D(1일), 20D(1개월), 50D(3개월), 120D(6개월), 200D.
 */
import fs from 'fs';
...
const REPLACEMENTS = [
  ...
  ["lang === 'en' ? '200D' : '200일'", "lang === 'en' ? '200D' : '200일'"],
  ['thChg1d: \'1일\', thRet20d: \'20일\'', "thChg1d: '1일', thRet20d: '20일'"],
  ['thRet50d: \'50일\'', "thRet50d: '50일'"],
  ['thRet120d: \'120일\'', "thRet120d: '120일'"],
  ['thRet200d: \'250일\'', "thRet200d: '200일'"],
  ...
  ['onclick="sortTable(\'ret200dPct\')">200일</th>', 'onclick="sortTable(\'ret200dPct\')">200일</th>'],
  ['"thChg1d":"1일"', '"thChg1d":"1일"'],
  ['"thRet20d":"20일"', '"thRet20d":"20일"'],
  ['"thRet50d":"50일"', '"thRet50d":"50일"'],
  ['"thRet120d":"120일"', '"thRet120d":"120일"'],
