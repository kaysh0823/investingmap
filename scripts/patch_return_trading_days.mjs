...
const REPLACEMENTS = [
  ...
  ["sortTable('ret1yPct')", "sortTable('ret250dPct')"],
  ['ret1mPct', 'ret20dPct'],
  ['ret3mPct', 'ret50dPct'],
  ['ret6mPct', 'ret120dPct'],
  ['ret1yPct', 'ret250dPct'],
  ...
  ["lang === 'en' ? '250D' : '1년'", "lang === 'en' ? '250D' : '250일'"],
  ...
  ['thRet1y.textContent', 'thRet250d.textContent'],
  ['"thChg1d":"전일대비"', '"thChg1d":"1일"'],
  ['"thRet20d":"1개월"', '"thRet20d":"20일"'],
  ['"thRet50d":"3개월"', '"thRet50d":"50일"'],
  ['"thRet120d":"6개월"', '"thRet120d":"120일"'],
