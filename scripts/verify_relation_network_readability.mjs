...
for (const c of CASES) {
  ...
  check(html.includes('relation_network.js?v=5'), `${c.id}: HTML must reference relation_network.js?v=5`);
  check(!html.includes('relation_network.js?v=4'), `${c.id}: stale v=4 script reference`);
