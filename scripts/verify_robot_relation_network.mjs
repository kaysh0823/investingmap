...
check(companies.length === 16, `listed 16 (got ${companies.length})`);
...
check(xref.length >= 3 && xref.every((e) => e.excludesFromOrphanResolution === true), 'xref ok');
...
check(metrics.listedCompanyCount === 16, 'metrics listed');
